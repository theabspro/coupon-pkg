...
app.component('CouponForm', {
    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope) {
        ...
        $scope.onSelectedCountry = function(id) {
            Coupon_get_state_by_country = vendor_get_state_by_country;
            $http.post(
                Coupon_get_state_by_country, { 'country_id': id }
            ).then(function(response) {
                // console.log(response);
        ...
        $scope.onSelectedState = function(id) {
            Coupon_get_city_by_state = vendor_get_city_by_state
            $http.post(
                Coupon_get_city_by_state, { 'state_id': id }
            ).then(function(response) {
                // console.log(response);
